@extends('theme')
        ...
        <div class="row profile">
            <div class="col s12 m12 l3 hide-on-med-and-down">
                <div class="profile-sidebar">
                    <!-- SIDEBAR USERPIC -->
                    <div class="profile-userpic" style="background-image: url('https://s3-ap-southeast-1.amazonaws.com/teachatco/images/phpGa1HuC.jpg')">
                        <span>
                ...
                <div class="profile-content">
                    <div class="row">
                        ...
                        <div class="col m3 s12 padding_adjust">
                            ...
                            <span class="info-box-icon blue" style="background-image: url('http://localhost:5000/images/bg_clip.png'); height: 120px !important; min-height: 123px !important; margin-bottom: 4px;">
                            <br/><span class="desc">Attachments</span>
                            <br/><span class="count">0</span>
                            </span>
                            </a>
                            <a href="#notif" id="notif_block" class="modal-trigger">
                            <span class="info-box-icon yellow darken-2" style="background-image: url('http://localhost:5000/images/bg_notif.png'); height: 120px !important; min-height: 123px !important">
                            <br/><span class="desc">Notifications</span>
                            <br/><span class="count">0</span>
                            </span>
                            </a>
                        </div>
                        <div class="col m3 s12 padding_adjust padding_adjust">
                            <a href="javascript:void(0)">
                            <span class="info-box-icon red" style="background-image: url('http://localhost:5000/images/bg_msg.png');">
                            ...
                            <div class="info-box">
                                ...
                                <span class="info-box-icon grey lighten-4 dash_container" style="padding: 5px;">
                                    <div class="dash_tile appointment">
                                        <figure style="background-image: url('https://s3-ap-southeast-1.amazonaws.com/teachatco/images/phpQscZ9h.png')"></figure>
                                        <span class="pull-right appt_class"><a href="#" id="9598821" onclick="functionCall('paolo');"><i class="material-icons tiny">videocam</i></a></span>
                                        <span class="title_tile">Teacher Account</span>
                            ...
                            <div class="info-box">
                                ...
                                <span class="info-box-icon grey lighten-4 dash_container" style="padding: 5px;">
                                    <div class="dash_tile">
                                        ...
                                        <span class="title_tile">Please pickup your children </span>
    ...
    <div id="announcement_view" class="modal modal-fixed-footer">
        <div class="modal-content">
            <h5>Please pickup your children </h5>
            <table>
                <tbody>
                    <tr>
