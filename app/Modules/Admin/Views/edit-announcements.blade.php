                            ...
                            <div class="row">
                                <form id="add-newAnnouncement" accept-charset="utf-8">
                                    <div class="input-field col s12 m12">
                                        <select name="announceTo" id="announceTo">
                                    ...
                                    <div class="input-field col s12 m12">
                                        <input id="announcement_title" name="announceTitle" type="text" class="validate" required="" value="{{ $announce[0]->announceTitle }}">
                                        <label for="announcement_title">Announcement Title</label>
                                    </div>
                                    <div class="input-field col s12">
                                        <textarea id="announcement_description" name="announcement" class="materialize-textarea" required="" >{{ $announce[0]->announcement }}</textarea>
                                        <label for="announcement_description">Announcement Description</label>
                                    </div>
                                    <input type="hidden" name="id" value="{{ $announce[0]->id }}"></input>
    ...
    @section('additional_bodytag')
        ...
        <script type="application/javascript">
            $(document).ready(function() {
                $('#announceTo').val(getSelector('{{ $announce[0]->announceTo }}'));
                ...
                $('#add-newAnnouncement').on('submit',function(e){
                    ...
                    var url = '/admin/v2/process/updateAnnouncement';
                    $.ajax({
                        type: "POST",
                        url: url,
                        processData:false,
