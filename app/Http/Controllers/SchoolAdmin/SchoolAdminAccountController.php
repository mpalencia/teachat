...
class SchoolAdminAccountController extends Controller
{
     ...
     * @return void
     */
    public function __construct(UserInterface $user, CountryInterface $country, StateUsInterface $stateUs, SchoolInterface $school)
    {
        $this->user = $user;
    ...
    /**
     * Display School Admin Account page.
     *
     * @return view
     */
    public function index()
    {
        ...
        $data = [
            ...
            'schools' => $this->school->getAllByAttributes(['country_id' => $country_id], 'school_name'),

        ];

        return view('school_admin.school-admin-account', $data);
    }
    ...
    public function getStateByCountryId($country_id)
    {
        ...
        if (!empty($state) || !empty($school)) {
            return ['result' => true, 'message' => $state, 'message1' => $school];
        }
