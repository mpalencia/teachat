...
@section('body_content')
						<div class="profile-content">
						    <div class="row">
						        ...
						        <div class="col m6 s10 padding_adjust right">
						            <div class="info-box">
						                <span class="info-title grey lighten-3"> Appointments today <a href="/parent/appointments/add" class="green right btn-floating"><i class="material-icons">add</i></a></span>
						                ...
						                @foreach($appointments_today as $at)
						                    @if($at['action'] === 'Accept' || $at['action'] === 'Inperson' || $at['action'] == null)
						                        <div class="dash_tile appointment" id="{{ $at->Appt_id }}">
						                        @if($at->active == 0)
						                            @if($at['profile_img'] === 'dp.png')
						                                <figure style="background-image: url('{{ asset('/images/dp.png') }}')"></figure>
						                            @else
						                                <figure style="background-image: url('https://s3-ap-southeast-1.amazonaws.com/teachatco/images/{{ $at['profile_img']  }}')"></figure>
						                            @endif
						                            <span class="pull-right appt_class"><a href="javascript:void(0)" id="{{ $at->qbUserId }}"><i class="material-icons tiny offline" >videocam_off</i></a></span>
						                        @else
						                            @if($at['profile_img'] === 'dp.png')
						                                <figure style="background-image: url('{{ asset('/images/dp.png') }}')"></figure>
						                            @else
						                            ...
						                            <span class="pull-right appt_class"><a href="#" id="btnCall" data-id="{{$at->parent_id}}"><i class="material-icons tiny">videocam</i></a></span>
						                        @endif
						                            <span class="title_tile">{{ $at['first_name'] }} {{ $at['last_name'] }}</span>
