<div style='color:#000 !important; font-family: Arial, Helvetica, sans-serif; width:100%;'>
	<div style='width:600px; margin: 0 auto; '>
		<center>
			...
			<h1 style='letter-spacing: 3px; color:#000 !important;'> Someone message you to Teachat!</h1>
        ...
        <p style='font-size: 100%; letter-spacing: 1px; color:#000 !important;'>
					{{$data['message']}}
				</p>
				<br>
					</span>
				<a href="dev3.teachat.co/login" style='text-decoration: none';>
