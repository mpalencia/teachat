    ...
    <div id="edit-announcements" class="modal edit-announcements">
        <div class="modal-content">
            ...
            <form id="form_edit_announcements" accept-charset="utf-8" class="row form_edit_announcements" >
                ...
                <div class="input-field col s12 m6">
                    <input id="epublish_on" type="date" required="" name="publish_on" class="datepicker">
                    <label for="epublish_on">Publish on</label>
                </div>
                <div class="input-field col s12 m6">
                    <input id="eexpiration_date" type="date" required="" name="expiration_date" class="datepicker">
                    <label for="eexpiration_date">Expiration Date</label>
                </div>
