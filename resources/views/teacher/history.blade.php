    ...
    <div class="message-item hvr-float" id="m16">
        <div class="message-inner">
            <div class="message-head clearfix">
                @if($appointment['parent']['profile_img'] == null || $appointment['parent']['profile_img'] == '')
                <div class="avatar pull-left" style="background-image: url('https://dev3.teachat.co/images/dp.png')"></div>
                @else
                <div class="avatar pull-left" style="background-image: url('https://s3-ap-southeast-1.amazonaws.com/teachatco/images/{{$appointment['parent']['profile_img']}}')"></div>
                @endif
                <div class="user-detail">
                    <h5 class="handle">Video chat with {{$appointment['parent']['first_name']}} {{$appointment['parent']['last_name']}} on </h5>
                    <div class="post-meta">
