...
<div class="profile-content">
    <div class="row">
        ...
        <div class="col m6 s12 padding_adjust right">
            <div class="info-box">
                <span class="info-title grey lighten-3"> Appointments today <a href="/teacher/appointments/create" class="green right btn-floating"><i class="material-icons">add</i></a></span>
                ...
                @foreach($appointments_today as $at)
                    @if($at->action === 'Accept' || $at->action === 'Inperson' || $at->action == null)
                        <div class="dash_tile appointment" id="{{ $at->id }}">
                            ...
                            @endif
                            <span class="pull-right appt_class"><a href="javascript:void(0)" data-parent-id="{{ $at->parent_id }}" id="" class="callParent"><i class="video_{{ $at->parent_id }} material-icons tiny offline" >videocam</i></a></span>
                            ...
                            <span class="title_tile">{{ $at->parent->first_name }} {{ $at->parent->last_name }}</span>
...
<input type="hidden" value="{{\Auth::user()->id}}" id="teacher_id" disabled="">
