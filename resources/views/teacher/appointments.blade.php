...
@section('body_content')
    ...
    <div class="profile-content">
        <div class="row">
            ...
            <a href="/teacher/appointments/create" class="btn waves-effect waves-light teal" type="submit" name="action">REQUEST
                        ...
                        <div id="appointment_listholder">
                            ...
                            @foreach($value as $item)
                                <li class="row">
                                    ...
                                    <?php $amazon_profile_pic = "https://s3-ap-southeast-1.amazonaws.com/teachatco/images/" . $item['parent']['profile_img'];?>
                                    @if($item['parent']['profile_img'] == 'dp.png')
                                    <figure style='background-image: url(" . asset("/images/dp.png") . ")'></figure>
                                    @else
                                    <figure style='background-image: url({{$amazon_profile_pic}})'></figure>
                                    @endif

                                    <span class="appointment_title"> {{$item["parent"]["first_name"]}} {{$item["parent"]["last_name"]}} </span>
                                    ...
                                    <div class="options_container">
                                        <div class="col s12 m4 options_btn">
                                            ...
                                            @elseif ($item['action'] === 'Inperson')
                                                <a class="waves-effect waves-light btn  blue darken-3 tooltipped" onClick="functionViewDetail({{$item['id']}});" href="#appointment_details" data-position="left" data-tooltip="See In person"><i class="material-icons">zoom_in</i></a>
                                            @endif
          ...
          //alert();
            $("#my-calendar").zabuto_calendar({
              ...
              //data: eventData,
                ...
                ajax: {
                    url: "/teacher/appointments/getAllByTeacher",
                    modal: false
                },
