    ...
    <nav class="blue-grey darken-4">
        <div class="container">
            ...
            <ul class="side-nav" id="mobile-demo">
                ...
                <li>
                    <a href="/teacher/myaccount" class="waves-effect"><i class="material-icons">perm_identity</i> My Account</span></a>
                </li>
                <li>
                    <a href="/teacher/students" class="waves-effect"><i class="material-icons">assignment_ind</i> Students </a>
                </li>
                <li>
                    <a href="/teacher/messages" class="waves-effect"><i class="material-icons">videocam</i>Video Chat </a>
                </li>
                <li>
                    <a href="/teacher/appointments" class="waves-effect"><i class="material-icons">perm_contact_calendar</i> Appointment </a>
                </li>
                <li>
    ...
    <script type="text/javascript">
        ...
        socket.connect(function(){
            ...
            socket.onIncomingCall(function(data){
                ...
                $('#incoming_call .accept_btn').prop('data-id', data.user_id);
