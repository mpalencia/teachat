...
@section('body_content')
    ...
    <div class="container policy">
        ...
        <p>
            <strong>However, you can still place orders .</strong><br/>
        ...
        <p>
            ...
            <ul>
                <li>• We have implemented the following:</li>
            </ul>
            <p>
